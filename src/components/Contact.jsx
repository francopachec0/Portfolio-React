    ...
    return (
        <div name='contact' className='w-full h-screen bg-[#0a1128] flex justify-center items-center p-4'>
            <form method='POST' action="https://getform.io/f/645ffd8c-9789-463e-a185-96bf1f503a87" className='flex flex-col max-w-[600px] w-full'>
                <div className='pb-8'>
                    <p className='text-4xl font-bold inline border-b-4 border-[#a31621] text-gray-50'>Contactáme</p>
                ...
                <button className='text-white border-2 hover:bg-[#a31621] hover:border-[#a31621] duration-300 rounded-lg px-4 py-3 my-8 mx-auto flex items-center'>Trabajémos Juntos</button>
            </form>
        </div>
    )
}
